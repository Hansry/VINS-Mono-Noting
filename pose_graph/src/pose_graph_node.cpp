...
void image_callback(const sensor_msgs::ImageConstPtr &image_msg)
{
    ...
    //若新到达的图像时间已超过上一帧图像时间1s或时间小于上一帧，则是新的图像序列
...
int main(int argc, char **argv)
{
    ...
    ros::Subscriber sub_pose = n.subscribe("/vins_estimator/keyframe_pose", 2000, pose_callback);//pose_buf
    ros::Subscriber sub_extrinsic = n.subscribe("/vins_estimator/extrinsic", 2000, extrinsic_callback);
    ros::Subscriber sub_point = n.subscribe("/vins_estimator/keyframe_point", 2000, point_callback); //point_buf
